...
import pristinehousing from './Images/Pristine Housing Solutions Logo.jpg';
    ...
    <div className='projectHolder' id='projects'>
      ...
      <div className="col-md-12">
        ...
        <h3 className='projectTitle'>Projects</h3>
          <img src={pristinehousing} className="projectImg card-img-top" alt="Project 1" />
      ...
      <div className="col-md-12">
        <div className="card">
          <img src={wheelLogo} className="projectImg card-img-top" alt="Project 1" />
          <div className="card-body">
            <h5 className="card-title">4 Wheel Barbers</h5>
            <p className="card-text">
              4 Wheel Barbers is a sleek website for a mobile barbershop, 
      ...
      <div className="col-md-12">
        <div className="card">
          <img src={aristoski_logo} className="projectImg card-img-top" alt="Project 1" />
          <div className="card-body">
            <h5 className="card-title">Aristoski Artist Page</h5>
            <p className="card-text">Aristoski.co.uk is a modern website built with React and hosted on Hostinger. It features a sleek design and responsive layout, providing a seamless user experience across all devices.</p>
